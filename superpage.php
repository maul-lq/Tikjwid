                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                            <ul class="py-2 text-sm text-white-700 dark:text-gray-100" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="<?= $HOSTURL; ?>page/idgham.php#Mutamasilain" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Mutamatsilain</a>
                                </li>
                                <li>
                                    <a href="<?= $HOSTURL; ?>page/idgham.php#Mutaqaribain" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Mutaqaribain</a>
                                </li>
                                <li>
                                    <a href="<?= $HOSTURL; ?>page/idgham.php#Mutajanisain" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Mutajanisain</a>
                                </li>
                            </ul>
                        </div>
                    </li>
